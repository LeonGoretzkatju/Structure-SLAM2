...
public:
    ...
    // with line and plane constraints
    ...
    void static LocalBundleAdjustment(KeyFrame* pKF, bool *pbStopFlag, Map *pMap); // num_fixedKF is unnecessary
    ...
    int static TranslationInertialOptimizationLastFrame(Frame *pFrame, bool bRecInit = false);
    int static TranslationInertialOptimizationLastKeyFrame(Frame *pFrame, bool bRecInit = false);
    ...
    // It is only used by LoopClosing and LoopClosing is disabled now
