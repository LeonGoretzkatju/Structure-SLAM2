...
//
    ...
    class EdgeInertialPlane : public BaseBinaryEdge<3, Plane3D, VertexPlane, ORB_SLAM2::VertexPose> {
        typedef pcl::PointXYZRGB PointT;
        typedef pcl::PointCloud<PointT> PointCloud;
    ...
    public:
        ...
        EdgeInertialPlane(int cam_idx_=0): cam_idx(cam_idx_){}
    ...
    class EdgeInertialPlaneOnlyPose : public g2o::BaseUnaryEdge<3, Plane3D, ORB_SLAM2::VertexPose>
    {
        typedef pcl::PointXYZRGB PointT;
        typedef pcl::PointCloud<PointT> PointCloud;
        typedef ORB_SLAM2::VertexPose VertexPose;
    public:
        ...
        EdgeInertialPlaneOnlyPose(const cv::Mat &Xw_, int cam_idx_=0):Xw(ORB_SLAM2::Converter::toPlane3D(Xw_)),
            cam_idx(cam_idx_){}
    ...
    class EdgeInertialPlaneOnlyTranslation : public g2o::BaseUnaryEdge<3, Plane3D, ORB_SLAM2::VertexPose>
    {
        typedef pcl::PointXYZRGB PointT;
        typedef pcl::PointCloud<PointT> PointCloud;
        typedef ORB_SLAM2::VertexPose VertexPose;
    public:
        ...
        EdgeInertialPlaneOnlyTranslation(const cv::Mat &Xw_, int cam_idx_=0):Xw(ORB_SLAM2::Converter::toPlane3D(Xw_)),
            cam_idx(cam_idx_){}
