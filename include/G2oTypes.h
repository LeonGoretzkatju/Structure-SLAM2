...
public:
    ...
    g2o::Isometry3D ProjectionMatrix(int cam_idx=0) const;
...
class EdgeMonoOnlyTranslation : public g2o::BaseUnaryEdge<2,Eigen::Vector2d,VertexPose>
{
public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW

    EdgeMonoOnlyTranslation(const cv::Mat &Xw_, int cam_idx_=0):Xw(Converter::toVector3d(Xw_)),
        cam_idx(cam_idx_){}
...
class EdgeStereoOnlyTranslation : public g2o::BaseUnaryEdge<3,Eigen::Vector3d,VertexPose>
{
public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW

    EdgeStereoOnlyTranslation(const cv::Mat &Xw_, int cam_idx_=0):
        Xw(Converter::toVector3d(Xw_)), cam_idx(cam_idx_){}
