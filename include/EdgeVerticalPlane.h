...
//        _jacobianOplusXi(1, 5) = 0;
    ...
    class EdgeInertialVerticalPlane : public BaseBinaryEdge<2, Plane3D, VertexPlane, ORB_SLAM2::VertexPose> {
        typedef ORB_SLAM2::VertexPose VertexPose;
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW;

        EdgeInertialVerticalPlane(int cam_idx_=0): cam_idx(cam_idx_){
        }
    ...
    class EdgeInertialVerticalPlaneOnlyPose : public g2o::BaseUnaryEdge<2, Plane3D, ORB_SLAM2::VertexPose>
    {
    ...
    public:
        ...
        EdgeInertialVerticalPlaneOnlyPose(const cv::Mat &Xw_, int cam_idx_=0):Xw(ORB_SLAM2::Converter::toPlane3D(Xw_)),
            cam_idx(cam_idx_){}
    ...
    class EdgeInertialVerticalPlaneOnlyTranslation : public g2o::BaseUnaryEdge<2, Plane3D, ORB_SLAM2::VertexPose>
    {
        typedef pcl::PointXYZRGB PointT;
        typedef pcl::PointCloud<PointT> PointCloud;
        typedef ORB_SLAM2::VertexPose VertexPose;
    public:
        ...
        EdgeInertialVerticalPlaneOnlyTranslation(const cv::Mat &Xw_, int cam_idx_=0):Xw(ORB_SLAM2::Converter::toPlane3D(Xw_)),
            cam_idx(cam_idx_){}
