...
#define FRAME_GRID_COLS 64
    ...
    public:
        ...
        // Inertial logic is only implemented in RGB-D frame
        Frame(const cv::Mat &imRGB, const cv::Mat &imGray, const cv::Mat &imDepth, const double &timeStamp, ORBextractor* extractor,ORBVocabulary* voc, cv::Mat &K, cv::Mat &distCoef, const float &bf, const float &thDepth, const float &depthMapFactor, GeometricCamera* pCamera, Frame* pPrevF = static_cast<Frame*>(NULL), const IMU::Calib &ImuCalib = IMU::Calib());
        ...
        double MinPointDistanceFromPlane(const cv::Mat &plane, PointCloud::Ptr pointCloud);
        bool MaxPointDistanceFromPlane(cv::Mat &plane, PointCloud::Ptr pointCloud);

        // IMU
        ConstraintPoseImu* mpcpi; // TODO: Optimizer.cc
    ...
    public:
        ...
        //seg_img created by AHCPlaneFilter
        cv::Mat seg_img;
        ...
        IMU::Preintegrated* mpImuPreintegrated; // TODO: LocalMapping.cc, Optimizer.cc, Tracking.cc (StereoInitialization),
        KeyFrame* mpLastKeyFrame; // move from protected
